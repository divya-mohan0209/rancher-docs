...
>**Note:** The intent of these guides is to quickly launch a sandbox that you can use to evaluate Rancher. The Docker install is not recommended for production environments. For comprehensive setup instructions, see [Installation](/rancher/v2.6.5/en/installation/installation_index).
...
### 1. Provision a Equinix Metal Host
  ...
  **Note:**
  ...
  > For a full list of port requirements, refer to [Docker Installation](/rancher/v2.6.5/en/cluster-provisioning/node-requirements/node-requirements_index).
  > Provision the host according to our [Requirements](/rancher/v2.6/en/installation/requirements/requirements_index).
...
Use Rancher to create a deployment. For more information, see [Creating Deployments](rancher/v2.6.5/en/quick-start-guide/workload/workload_index).
