...
>Note: Users may opt to enable [token hashing](/rancher/v2.6.5/en/api/api-tokens/api-tokens_index).
...
- API keys are used for API calls and [Rancher CLI](/rancher/v2.6.5/en/cli/cli_index).
