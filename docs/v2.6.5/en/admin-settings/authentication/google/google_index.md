...
Within Rancher, only administrators or users with the **Manage Authentication** [global role](/rancher/v2.6.5/en/admin-settings/rbac/global-permissions/) can configure authentication.
...
1. Sign into Rancher using a local user assigned the [administrator](/rancher/v2.6.5/en/admin-settings/rbac/global-permissions) role. This user is also called the local principal.
