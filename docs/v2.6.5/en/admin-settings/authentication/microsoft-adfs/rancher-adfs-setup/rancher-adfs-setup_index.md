...
After you complete [Configuring Microsoft AD FS for Rancher](/v2.6.5/en/admin-settings/authentication/microsoft-adfs/microsoft-adfs-setup/), enter your AD FS information into Rancher to allow AD FS users to authenticate with Rancher.
